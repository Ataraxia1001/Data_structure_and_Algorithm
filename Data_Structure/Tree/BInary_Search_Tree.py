...
#explaining which conditions are being checked
    def remove(self, data): #! watch: https://www.youtube.com/watch?v=gcULXE7ViZw
        ...
        while current_node!=None: #Traversing the tree to reach the desired node or the end of the tree
            if current_node.data > data:
                ...
                #Match is found. Different cases to be checked. 
                ...
                #Node has both left and right child
                    ...
                    while del_node.left != None: #Loop to reach the leftmost node of the right subtree of the current node
                        del_node_parent = del_node    # leftmost node is minimum value of the right subtree, which won't violate rule of BST.
                    ...
                    if del_node.right == None: #If the leftmost node of the right subtree of the current node has no right subtree
                        ...
                        return
                        # del_node cannot have a left child as it is the leftmost node of the right subtree of the current node.
        return "Not Found"
