...
# watch youtube video for better understanding:
...
def partition(array, left, right):
    ...
    for i in range(left, right):
        global count
        count += 1           # array[i] = itemFromRight   
        if array[i] < pivot: # itemFromLeft larger than pivot, itemFromRight smaller than pivot
            smaller_index += 1   # array[smaller_index] = itemFromLeft
